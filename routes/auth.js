...
const CHAT_ENGINE_PROJECT_ID = "a68e8e6f-9f08-4e34-899e-85e15fb46ed1";
const CHAT_ENGINE_PRIVATE_KEY = "5c767410-3075-4a73-9880-348c3bfb63ea";

router.post("/chat_signup", async (req, res) => {
...
router.post("/chat_login", async (req, res) => {
